...
button_4 = ttk.Button(win, text="*", command=lambda:press("*"))
button_4.grid(row=2, column=3)

button_5 = ttk.Button(win, text="1", command=lambda:press(1))
button_5.grid(row=3, column=0)

button_6= ttk.Button(win, text="2", command=lambda:press(2))
button_6.grid(row=3, column=1)

button_5 = ttk.Button(win, text="3", command=lambda:press(3))
button_5.grid(row=3, column=2)

button_6= ttk.Button(win, text="-", command=lambda:press("-"))
